...
func main() {
	...
	fmt.Println("Let's take the task and channel out of the work, now. Notice that the context will not cancel again.")
	c.T = nil
	c.C = nil
